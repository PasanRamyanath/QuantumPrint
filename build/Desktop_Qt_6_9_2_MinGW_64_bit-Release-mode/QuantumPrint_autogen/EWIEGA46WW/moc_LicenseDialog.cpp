...
template <> constexpr inline auto LicenseDialog::qt_create_metaobjectdata<qt_meta_tag_ZN13LicenseDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'formatLicenseKey'
        QtMocHelpers::SlotData<void(const QString &)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 3 },
        }}),
        // Slot 'activateLicense'
...
void LicenseDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->formatLicenseKey((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->activateLicense(); break;
        default: ;
        }
    }
}
